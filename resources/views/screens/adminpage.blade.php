...
<div id="Home" class="tabcontent" >
    ...
    <input type="text" id="insertadd" name="insertadd" placeholder="Your address..">
	
	<label  for="newservicedescription">Add new role: </label>
    <input type="text" id="insertrole" name="insertrole" placeholder="Your role..">
	
	<label  for="newservicecharge">Add a new phone number: </label>
    <input type="text" id="insertphone" name="insertphone" placeholder="phone number" required>
	
	<label  for="newserviceImage">Add new website name: </label>
    <input type="text" id="insertwebsite" name="insertwebsite" placeholder="Your website name..">
    
    <label  for="newserviceImage">Add new skype name: </label>
    <input type="text" id="insertskype" name="insertskype" placeholder="Your skype name..">
    
    <label  for="newserviceImage">Add new cv: </label>
    <input type="text" id="insertcv" name="insertcv" placeholder="Your cv ..">
     ...
     <textarea rows="10" cols="50" id="addDescription" name="addDescription" placeholder="Your Description"></textarea>

   
	<div id="submitservice">
    <button name="insProfile" value="Submit" class="buttonsignupcon">Insert</button> 
	<button onclick="location.href='{{ url('/deletescreen') }}'" name="delProfile" value="Delete" class="buttonsignupcon">Update/Delete</button> 
	</div>
	</form>
...
<div id="News" class="tabcontent">
  <div class="container">
	...
	<form method="POST" action="{{url('/insertresume')}}">
	{{csrf_field()}}
   ...
   <br>
    ...
    <a href ="{{ url('/deletejob') }}" name="delProfile" value="Delete">Update/Delete</a> 
...
<div id="Contact" class="tabcontent">
   <div class="container">
	...
	<form action="{{url('/insertskill')}}" method="POST">
	{{csrf_field()}}
...
<button name="skillsubmit" value="Submit" class="buttonsignupcon">Insert</button> 
  ...
  <div align="left">
 <form method="POST" action="{{url('/insertportfolio')}}" enctype="multipart/form-data">
  {{csrf_field()}}
...
<a href ="{{ url('/deleteportfolio') }}" name="delProfile" value="Delete">Update/Delete</a> 
...
<div id="About" class="tabcontent">
	...
	<form action="{{url('/insertservice')}}" enctype="multipart/form-data" method="POST">
	{{csrf_field()}}
   ...
   <br>
    ...
    <a href ="{{ url('/deleteservice') }}" name="delProfile" value="Delete">Update/Delete</a> 
