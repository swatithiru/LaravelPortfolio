...
<script src="{{asset('js/newuserValidate.js')}}"></script>
<script src="{{asset('js/newloginValidate.js')}}"></script>
<script>
...
<div class="row">
  ...
  <div class="col left">
  <div class="logo">
 <img src="{{URL('/images/logo.png')}}"class="center" alt="logo"/>
  ...
  ?>
  <a  href="{{ url('/forget') }}" class="bu">WELCOME <?php echo $msg;?></a>
<?php 
 echo '</div>';
  }
  ?>
...
<nav class="navbar">
   ...
   if($msg == 'none')
   {
	   ?>
   <ul>
   <li><a href="{{ url('/index') }}" class="bu">HOME</a></li>
   <li><a href="{{ url('/aboutme') }}" class="bu">ABOUT</a></li>
   <li><a href="{{ url('/skill') }}" class="bu">SKILLS</a></li>
   <li><a href="{{ url('/index') }}" class="bu">RESUMES</a></li>
   <li><a href="{{url('/index') }}" class="bu">PORTFOLIO</a></li>
   <li><a href="{{url('/index') }}" class="bu">BLOG</a></li>
   <li><a href="{{url('/index') }}" class="bu">HIRE ME</a></li>
   <li><a href="#" class="bu" id="buttonlogin">LOGIN</a></li>
   <li><a href="#" class="bu" id="buttonsignup">SIGNUP</a></li>
   <li><a href="{{url('/index') }}" class="bu">REFERENCES</a></li>
   <div class="footer"><p><small>&copy; DiazApps ALL RIGHTS <br> RESERVED BY <font color="blue">&nbsp;&nbsp;Swati <br></font></small></p></div>
   </ul>
   <?php
   }
   else
   ...
   <li><a href="{{ url('/aboutme') }}" class="bu">ABOUT</a></li>
   <li><a href="{{ url('/skill') }}" class="bu">SKILLS</a></li>
   <li><a href="{{ url('/resume') }}" class="bu">RESUMES</a></li>
   <li><a href="{{ url('/portfolio') }}" class="bu">PORTFOLIO</a></li>
   <li><a href="http://swatithirunavakarasu.uta.cloud/" class="bu">BLOG</a></li>
   <li><a href="{{url('/hireme') }}" class="bu">HIRE ME</a></li>
   <li><a href="#" class="bu" id="buttonlogin">LOGIN</a></li>
   <li><a href="#" class="bu" id="buttonsignup">SIGNUP</a></li>
   <li><a href="{{url('/references') }}" class="bu">REFERENCES</a></li>
   <div class="footer"><p><small>&copy; DiazApps ALL RIGHTS <br> RESERVED BY <font color="blue">&nbsp;&nbsp;Swati <br></font></small></p></div>
   </ul>
   <!--echo '<ul>';
   echo '<li><a href="{{ url("/home") }}" class="bu">HOME</a></li>';
   echo '<li><a href="{{ url("/aboutme") }}" class="bu">ABOUT</a></li>';
   echo '<li><a href="{{ url("/skill") }}" class="bu">SKILLS</a></li>';
  ...
  <div class="vertical-center">
	...
	<p class="normalindex">MOBILE DEVELOPER</p>
    <div>
    <form method="GET" action="{{URL('/files/resume.doc')}}">
	{{csrf_field()}}
...
<div class="contain">
    <form id="loginForm" name="loginForm" method="get" action="{{url('/display')}}">
	{{csrf_field()}}
    <div  class="popup">
	<div class="popup-content">
	<p id="log"> Log in </p> <img src="{{URL('/images/cancel.jpg')}}" alt="close" class="close">
	@if ($errors->any())
	...
	<input class ="signinin" type="text" id="name_text" name="name_text" minlength="2" maxlength="15" onblur="validateUserName()" required>
	</div>
...
<div class="containsignup">
    <form id="signupForm" name="signupForm" action="{{url('/submitted')}}" method="POST">
	{{csrf_field()}}
	<div  class="popupsignup">
	<div class="popupsignup-content">
	<p class="log"> Check in </p> <img src="{{URL('/images/cancel.jpg')}}" alt="close" class="closesignup">
	@if ($errors->any())
      <div class="alert alert-danger">
          <ul>
              @foreach ($errors->all() as $error)
